...
StructType::StructType() : ns::Object(ns::Handle{(__bridge void*)[[MTLStructType alloc] init]}) {}
...
ArrayType::ArrayType() : ns::Object(ns::Handle{(__bridge void*)[[MTLArrayType alloc] init]}) {}
...
Argument::Argument() : ns::Object(ns::Handle{(__bridge void*)[[MTLArgument alloc] init]}) {}
...
void BlitCommandEncoder::Copy(const Texture& sourceTexture, uint32_t sourceSlice,
...
void BlitCommandEncoder::Fill(const Buffer& buffer, const ns::Range& range, uint8_t value) {
  Validate();
  [(__bridge id<MTLBlitCommandEncoder>)m_ptr fillBuffer:(__bridge id<MTLBuffer>)buffer.GetPtr()
...
#if MTLPP_IS_AVAILABLE(10_12, 10_0)
  [(__bridge id<MTLBuffer>)m_ptr addDebugMarker:(__bridge NSString*)marker.GetPtr()
                                          range:NSMakeRange(range.Location, range.Length)];
#endif
}
...
CommandBuffer CommandQueue::CommandBufferWithUnretainedReferences() {
  Validate();
  return ns::Handle{
      (__bridge void*)[(__bridge id<MTLCommandQueue>)m_ptr commandBufferWithUnretainedReferences]};
}
...
void ComputeCommandEncoder::SetComputePipelineState(const ComputePipelineState& state) {
  ...
  [(__bridge id<MTLComputeCommandEncoder>)m_ptr
      setComputePipelineState:(__bridge id<MTLComputePipelineState>)state.GetPtr()];
}
...
void ComputeCommandEncoder::SetBuffer(const Buffer& buffer, uint32_t offset, uint32_t index) {
  Validate();
  [(__bridge id<MTLComputeCommandEncoder>)m_ptr setBuffer:(__bridge id<MTLBuffer>)buffer.GetPtr()
                                                   offset:offset
                                                  atIndex:index];
}
...
void ComputeCommandEncoder::SetBuffers(const Buffer* buffers, const uint32_t* offsets,
...
void ComputeCommandEncoder::SetTexture(const Texture& texture, uint32_t index) {
  Validate();
  [(__bridge id<MTLComputeCommandEncoder>)m_ptr setTexture:(__bridge id<MTLTexture>)texture.GetPtr()
                                                   atIndex:index];
}
...
void ComputeCommandEncoder::SetSamplerState(const SamplerState& sampler, float lodMinClamp,
...
#if MTLPP_IS_AVAILABLE(10_12, 10_0)
  [(__bridge id<MTLComputeCommandEncoder>)m_ptr
      setStageInRegion:MTLRegionMake3D(region.Origin.X, region.Origin.Y, region.Origin.Z,
                                       region.Size.Width, region.Size.Height, region.Size.Depth)];
#endif
}

void ComputeCommandEncoder::DispatchThreadgroups(const Size& threadgroupsPerGrid,
                                                 const Size& threadsPerThreadgroup) {
  Validate();
  MTLSize mtlThreadgroupsPerGrid =
      MTLSizeMake(threadgroupsPerGrid.Width, threadgroupsPerGrid.Height, threadgroupsPerGrid.Depth);
  MTLSize mtlThreadsPerThreadgroup = MTLSizeMake(
      threadsPerThreadgroup.Width, threadsPerThreadgroup.Height, threadsPerThreadgroup.Depth);
  [(__bridge id<MTLComputeCommandEncoder>)m_ptr dispatchThreadgroups:mtlThreadgroupsPerGrid
                                               threadsPerThreadgroup:mtlThreadsPerThreadgroup];
}
void ComputeCommandEncoder::DispatchThread(const Size& threadgroupsPerGrid,
                                           const Size& threadsPerThreadgroup) {
  Validate();
  MTLSize mtlThreadgroupsPerGrid =
      MTLSizeMake(threadgroupsPerGrid.Width, threadgroupsPerGrid.Height, threadgroupsPerGrid.Depth);
  MTLSize mtlThreadsPerThreadgroup = MTLSizeMake(
      threadsPerThreadgroup.Width, threadsPerThreadgroup.Height, threadsPerThreadgroup.Depth);
  [(__bridge id<MTLComputeCommandEncoder>)m_ptr dispatchThreads:mtlThreadgroupsPerGrid
                                          threadsPerThreadgroup:mtlThreadsPerThreadgroup];
}
...
void ComputeCommandEncoder::DispatchThreadgroupsWithIndirectBuffer(
  ...
  MTLSize mtlThreadsPerThreadgroup = MTLSizeMake(
      threadsPerThreadgroup.Width, threadsPerThreadgroup.Height, threadsPerThreadgroup.Depth);
  [(__bridge id<MTLComputeCommandEncoder>)m_ptr
      dispatchThreadgroupsWithIndirectBuffer:(__bridge id<MTLBuffer>)indirectBuffer.GetPtr()
...
Function ComputePipelineDescriptor::GetComputeFunction() const {
  Validate();
  return ns::Handle{
      (__bridge void*)[(__bridge MTLComputePipelineDescriptor*)m_ptr computeFunction]};
}

bool ComputePipelineDescriptor::GetThreadGroupSizeIsMultipleOfThreadExecutionWidth() const {
  Validate();
  return [(
      __bridge MTLComputePipelineDescriptor*)m_ptr threadGroupSizeIsMultipleOfThreadExecutionWidth];
}
...
#if MTLPP_IS_AVAILABLE(10_12, 10_0)
  return ns::Handle{
      (__bridge void*)[(__bridge MTLComputePipelineDescriptor*)m_ptr stageInputDescriptor]};
#else
  return ns::Handle{nullptr};
#endif
}
...
void StencilDescriptor::SetDepthStencilPassOperation(StencilOperation depthStencilPassOperation) {
  Validate();
  [(__bridge MTLStencilDescriptor*)m_ptr
      setDepthStencilPassOperation:MTLStencilOperation(depthStencilPassOperation)];
}
...
void DepthStencilDescriptor::SetFrontFaceStencil(const StencilDescriptor& frontFaceStencil) const {
  Validate();
  [(__bridge MTLDepthStencilDescriptor*)m_ptr
      setFrontFaceStencil:(__bridge MTLStencilDescriptor*)frontFaceStencil.GetPtr()];
}

void DepthStencilDescriptor::SetBackFaceStencil(const StencilDescriptor& backFaceStencil) const {
  Validate();
  [(__bridge MTLDepthStencilDescriptor*)m_ptr
      setBackFaceStencil:(__bridge MTLStencilDescriptor*)backFaceStencil.GetPtr()];
}
...
SizeAndAlign Device::HeapTextureSizeAndAlign(const TextureDescriptor& desc) {
  ...
  MTLSizeAndAlign mtlSizeAndAlign = [(__bridge id<MTLDevice>)m_ptr
      heapTextureSizeAndAlignWithDescriptor:(__bridge MTLTextureDescriptor*)desc.GetPtr()];
...
#if MTLPP_IS_AVAILABLE_IOS(10_0)
  MTLSizeAndAlign mtlSizeAndAlign =
      [(__bridge id<MTLDevice>)m_ptr heapBufferSizeAndAlignWithLength:length
...
Buffer Device::NewBuffer(void* pointer, uint32_t length, ResourceOptions options,
...
DepthStencilState Device::NewDepthStencilState(const DepthStencilDescriptor& descriptor) {
  Validate();
  return ns::Handle{(__bridge void*)[(__bridge id<MTLDevice>)m_ptr
      newDepthStencilStateWithDescriptor:(__bridge MTLDepthStencilDescriptor*)descriptor.GetPtr()]};
}

Texture Device::NewTexture(const TextureDescriptor& descriptor) {
  Validate();
  return ns::Handle{(__bridge void*)[(__bridge id<MTLDevice>)m_ptr
      newTextureWithDescriptor:(__bridge MTLTextureDescriptor*)descriptor.GetPtr()]};
}

//- (id <MTLTexture>)newTextureWithDescriptor:(MTLTextureDescriptor *)descriptor
// iosurface:(IOSurfaceRef)iosurface plane:(NSUInteger)plane NS_AVAILABLE_MAC(10_11);
SamplerState Device::NewSamplerState(const SamplerDescriptor& descriptor) {
  Validate();
  return ns::Handle{(__bridge void*)[(__bridge id<MTLDevice>)m_ptr
      newSamplerStateWithDescriptor:(__bridge MTLSamplerDescriptor*)descriptor.GetPtr()]};
}
...
Library Device::NewLibrary(const ns::String& filepath, ns::Error* error) {
  ...
  id<MTLLibrary> library =
      [(__bridge id<MTLDevice>)m_ptr newLibraryWithFile:(__bridge NSString*)filepath.GetPtr()
                                                  error:nsErrorPtr];
...
void Device::NewLibrary(const char* source, const CompileOptions& options,
...
RenderPipelineState Device::NewRenderPipelineState(const RenderPipelineDescriptor& descriptor,
                                                   ns::Error* error) {
  Validate();
  ...
  id<MTLRenderPipelineState> renderPipelineState = [(__bridge id<MTLDevice>)m_ptr
...
RenderPipelineState Device::NewRenderPipelineState(const RenderPipelineDescriptor& descriptor,
                                                   ...
                                                   RenderPipelineReflection* outReflection,
                                                   ns::Error* error) {
  Validate();
...
void Device::NewRenderPipelineState(
    ...
    std::function<void(const RenderPipelineState&, const ns::Error&)> completionHandler) {
  Validate();
  [(__bridge id<MTLDevice>)m_ptr
      newRenderPipelineStateWithDescriptor:(__bridge MTLRenderPipelineDescriptor*)
                         ...
                         completionHandler:^(id<MTLRenderPipelineState> renderPipelineState,
                                             NSError* error) {
                           completionHandler(ns::Handle{(__bridge void*)renderPipelineState},
                                             ns::Handle{(__bridge void*)error});
                         }];
}
...
void Device::NewRenderPipelineState(
    ...
    std::function<void(const RenderPipelineState&, const RenderPipelineReflection&,
                       const ns::Error&)>
        completionHandler) {
  Validate();
  [(__bridge id<MTLDevice>)m_ptr
...
ComputePipelineState Device::NewComputePipelineState(const Function& computeFunction,
                                                     ns::Error* error) {
  Validate();
  ...
  id<MTLComputePipelineState> state = [(__bridge id<MTLDevice>)m_ptr
      newComputePipelineStateWithFunction:(__bridge id<MTLFunction>)computeFunction.GetPtr()
                                    error:nsErrorPtr];
...
ComputePipelineState Device::NewComputePipelineState(const Function& computeFunction,
                                                     PipelineOption options,
                                                     ComputePipelineReflection& outReflection,
                                                     ns::Error* error) {
  Validate();
  return ns::Handle{nullptr};
}
...
void Device::NewComputePipelineState(
    ...
    std::function<void(const ComputePipelineState&, const ns::Error&)> completionHandler) {
  Validate();
  [(__bridge id<MTLDevice>)m_ptr
      newComputePipelineStateWithFunction:(__bridge id<MTLFunction>)computeFunction.GetPtr()
                        completionHandler:^(id<MTLComputePipelineState> computePipelineState,
                                            NSError* error) {
                          completionHandler(ns::Handle{(__bridge void*)computePipelineState},
                                            ns::Handle{(__bridge void*)error});
                        }];
}
...
void Device::NewComputePipelineState(
    ...
    std::function<void(const ComputePipelineState&, const ComputePipelineReflection&,
                       const ns::Error&)>
        completionHandler) {
  Validate();
  [(__bridge id<MTLDevice>)m_ptr
...
ComputePipelineState Device::NewComputePipelineState(const ComputePipelineDescriptor& descriptor,
                                                     PipelineOption options,
                                                     ComputePipelineReflection* outReflection,
                                                     ns::Error* error) {
  Validate();
  ...
  id<MTLComputePipelineState> state = [(__bridge id<MTLDevice>)m_ptr
      newComputePipelineStateWithDescriptor:(__bridge MTLComputePipelineDescriptor*)
                                                descriptor.GetPtr()
                                    options:MTLPipelineOption(options)
                                 reflection:reflectionPtr
                                      error:nsErrorPtr];
...
void FunctionConstantValues::SetConstantValue(const void* value, DataType type, uint32_t index) {
  Validate();
#if MTLPP_IS_AVAILABLE(10_12, 10_0)
  [(__bridge MTLFunctionConstantValues*)m_ptr setConstantValue:value
...
Function Library::NewFunction(const ns::String& functionName,
                              const FunctionConstantValues& constantValues, ns::Error* error) {
  Validate();
#if MTLPP_IS_AVAILABLE(10_12, 10_0)
  // Error
  NSError* nsError = NULL;
...
void Library::NewFunction(
    const ns::String& functionName, const FunctionConstantValues& constantValues,
    std::function<void(const Function&, const ns::Error&)> completionHandler) {
  Validate();
#if MTLPP_IS_AVAILABLE(10_12, 10_0)
...
Object& Object::operator=(const Object& rhs) {
  if (rhs.m_ptr == m_ptr) return *this;
  if (rhs.m_ptr) CFRetain(rhs.m_ptr);
  if (m_ptr) CFRelease(m_ptr);
  m_ptr = rhs.m_ptr;
  return *this;
}
...
RenderCommandEncoder ParallelRenderCommandEncoder::GetRenderCommandEncoder() {
  Validate();
  return ns::Handle{
      (__bridge void*)[(__bridge id<MTLParallelRenderCommandEncoder>)m_ptr renderCommandEncoder]};
}

void ParallelRenderCommandEncoder::SetColorStoreAction(StoreAction storeAction,
...
void RenderCommandEncoder::SetRenderPipelineState(const RenderPipelineState& pipelineState) {
  ...
  [(__bridge id<MTLRenderCommandEncoder>)m_ptr
      setRenderPipelineState:(__bridge id<MTLRenderPipelineState>)pipelineState.GetPtr()];
}
...
void RenderCommandEncoder::SetVertexBuffers(const Buffer* buffers, const uint32_t* offsets,
                                            const ns::Range& range) {
  Validate();
...
void RenderCommandEncoder::SetVertexSamplerState(const SamplerState& sampler, float lodMinClamp,
                                                 float lodMaxClamp, uint32_t index) {
  Validate();
  [(__bridge id<MTLRenderCommandEncoder>)m_ptr
      setVertexSamplerState:(__bridge id<MTLSamplerState>)sampler.GetPtr()
...
void RenderCommandEncoder::SetFragmentData(const void* bytes, uint32_t length, uint32_t index) {
  Validate();
#if MTLPP_IS_AVAILABLE(10_11, 8_3)
  [(__bridge id<MTLRenderCommandEncoder>)m_ptr setFragmentBytes:bytes length:length atIndex:index];
#endif
}

void RenderCommandEncoder::SetFragmentBuffer(const Buffer& buffer, uint32_t offset,
                                             uint32_t index) {
  Validate();
  [(__bridge id<MTLRenderCommandEncoder>)m_ptr
...
void RenderCommandEncoder::SetFragmentBuffers(const Buffer* buffers, const uint32_t* offsets,
                                              const ns::Range& range) {
  Validate();
...
void RenderCommandEncoder::SetFragmentSamplerStates(const SamplerState* samplers,
                                                    const ns::Range& range) {
  Validate();
...
void RenderCommandEncoder::SetFragmentSamplerState(const SamplerState& sampler, float lodMinClamp,
                                                   float lodMaxClamp, uint32_t index) {
  Validate();
  [(__bridge id<MTLRenderCommandEncoder>)m_ptr
      setFragmentSamplerState:(__bridge id<MTLSamplerState>)sampler.GetPtr()
...
void RenderCommandEncoder::SetDepthStencilState(const DepthStencilState& depthStencilState) {
  Validate();
  [(__bridge id<MTLRenderCommandEncoder>)m_ptr
      setDepthStencilState:(__bridge id<MTLDepthStencilState>)depthStencilState.GetPtr()];
}
...
void RenderCommandEncoder::SetStencilReferenceValue(uint32_t frontReferenceValue,
                                                    uint32_t backReferenceValue) {
  Validate();
  [(__bridge id<MTLRenderCommandEncoder>)m_ptr setStencilFrontReferenceValue:frontReferenceValue
...
void RenderCommandEncoder::SetVisibilityResultMode(VisibilityResultMode mode, uint32_t offset) {
  Validate();
  [(__bridge id<MTLRenderCommandEncoder>)m_ptr setVisibilityResultMode:MTLVisibilityResultMode(mode)
                                                                offset:offset];
}
...
void RenderCommandEncoder::SetColorStoreAction(StoreAction storeAction,
  ...
  Validate();
#if MTLPP_IS_AVAILABLE(10_12, 10_0)
  [(__bridge id<MTLRenderCommandEncoder>)m_ptr setColorStoreAction:MTLStoreAction(storeAction)
                                                           atIndex:colorAttachmentIndex];
#endif
}
...
void RenderCommandEncoder::Draw(PrimitiveType primitiveType, uint32_t vertexStart,
...
void RenderCommandEncoder::Draw(PrimitiveType primitiveType, Buffer indirectBuffer,
...
void RenderCommandEncoder::DrawIndexed(PrimitiveType primitiveType, uint32_t indexCount,
...
void RenderCommandEncoder::DrawIndexed(PrimitiveType primitiveType, IndexType indexType,
...
void RenderCommandEncoder::UpdateFence(const Fence& fence, RenderStages afterStages) {
  Validate();
#if MTLPP_IS_AVAILABLE_IOS(10_0)
  [(__bridge id<MTLRenderCommandEncoder>)m_ptr updateFence:(__bridge id<MTLFence>)fence.GetPtr()
...
void RenderCommandEncoder::WaitForFence(const Fence& fence, RenderStages beforeStages) {
  Validate();
#if MTLPP_IS_AVAILABLE_IOS(10_0)
  [(__bridge id<MTLRenderCommandEncoder>)m_ptr waitForFence:(__bridge id<MTLFence>)fence.GetPtr()
                                               beforeStages:MTLRenderStages(beforeStages)];
#endif
}

void RenderCommandEncoder::SetTessellationFactorBuffer(const Buffer& buffer, uint32_t offset,
...
void RenderCommandEncoder::DrawPatches(uint32_t numberOfPatchControlPoints, uint32_t patchStart,
...
void RenderCommandEncoder::DrawIndexedPatches(uint32_t numberOfPatchControlPoints,
...
Texture RenderPassAttachmentDescriptor::GetResolveTexture() const {
  Validate();
  return ns::Handle{
      (__bridge void*)[(__bridge MTLRenderPassAttachmentDescriptor*)m_ptr resolveTexture]};
}
...
RenderPassColorAttachmentDescriptor::RenderPassColorAttachmentDescriptor()
    : RenderPassAttachmentDescriptor(
          ns::Handle{(__bridge void*)[[MTLRenderPassColorAttachmentDescriptor alloc] init]}) {}
...
void RenderPassColorAttachmentDescriptor::SetClearColor(const ClearColor& clearColor) {
  Validate();
  MTLClearColor mtlClearColor = {clearColor.Red, clearColor.Green, clearColor.Blue,
                                 clearColor.Alpha};
...
RenderPassDepthAttachmentDescriptor::RenderPassDepthAttachmentDescriptor()
    : RenderPassAttachmentDescriptor(
          ns::Handle{(__bridge void*)[[MTLRenderPassDepthAttachmentDescriptor alloc] init]}) {}
...
MultisampleDepthResolveFilter RenderPassDepthAttachmentDescriptor::GetDepthResolveFilter() const {
  ...
  return MultisampleDepthResolveFilter(
      [(__bridge MTLRenderPassDepthAttachmentDescriptor*)m_ptr depthResolveFilter]);
#else
...
void RenderPassDepthAttachmentDescriptor::SetDepthResolveFilter(
  ...
  [(__bridge MTLRenderPassDepthAttachmentDescriptor*)m_ptr
      setDepthResolveFilter:MTLMultisampleDepthResolveFilter(depthResolveFilter)];
#endif
}

RenderPassStencilAttachmentDescriptor::RenderPassStencilAttachmentDescriptor()
    : RenderPassAttachmentDescriptor(
          ns::Handle{(__bridge void*)[[MTLRenderPassStencilAttachmentDescriptor alloc] init]}) {}
...
Buffer RenderPassDescriptor::GetVisibilityResultBuffer() const {
  Validate();
  return ns::Handle{
      (__bridge void*)[(__bridge MTLRenderPassDescriptor*)m_ptr visibilityResultBuffer]};
}
...
void RenderPassDescriptor::SetVisibilityResultBuffer(const Buffer& visibilityResultBuffer) {
  Validate();
  [(__bridge MTLRenderPassDescriptor*)m_ptr
      setVisibilityResultBuffer:(__bridge id<MTLBuffer>)visibilityResultBuffer.GetPtr()];
}
...
RenderPipelineColorAttachmentDescriptor::RenderPipelineColorAttachmentDescriptor()
    : ns::Object(
          ns::Handle{(__bridge void*)[[MTLRenderPipelineColorAttachmentDescriptor alloc] init]}) {}
...
BlendFactor RenderPipelineColorAttachmentDescriptor::GetSourceRgbBlendFactor() const {
  Validate();
  return BlendFactor(
      [(__bridge MTLRenderPipelineColorAttachmentDescriptor*)m_ptr sourceRGBBlendFactor]);
}

BlendFactor RenderPipelineColorAttachmentDescriptor::GetDestinationRgbBlendFactor() const {
  Validate();
  return BlendFactor(
      [(__bridge MTLRenderPipelineColorAttachmentDescriptor*)m_ptr destinationRGBBlendFactor]);
}

BlendOperation RenderPipelineColorAttachmentDescriptor::GetRgbBlendOperation() const {
  Validate();
  return BlendOperation(
      [(__bridge MTLRenderPipelineColorAttachmentDescriptor*)m_ptr rgbBlendOperation]);
}

BlendFactor RenderPipelineColorAttachmentDescriptor::GetSourceAlphaBlendFactor() const {
  Validate();
  return BlendFactor(
      [(__bridge MTLRenderPipelineColorAttachmentDescriptor*)m_ptr sourceAlphaBlendFactor]);
}

BlendFactor RenderPipelineColorAttachmentDescriptor::GetDestinationAlphaBlendFactor() const {
  Validate();
  return BlendFactor(
      [(__bridge MTLRenderPipelineColorAttachmentDescriptor*)m_ptr destinationAlphaBlendFactor]);
}

BlendOperation RenderPipelineColorAttachmentDescriptor::GetAlphaBlendOperation() const {
  Validate();
  return BlendOperation(
      [(__bridge MTLRenderPipelineColorAttachmentDescriptor*)m_ptr alphaBlendOperation]);
}
...
void RenderPipelineColorAttachmentDescriptor::SetDestinationAlphaBlendFactor(
  ...
  Validate();
  [(__bridge MTLRenderPipelineColorAttachmentDescriptor*)m_ptr
      setDestinationAlphaBlendFactor:MTLBlendFactor(destinationAlphaBlendFactor)];
}
...
const ns::Array<Argument> RenderPipelineReflection::GetFragmentArguments() const {
  Validate();
  return ns::Handle{
      (__bridge void*)[(__bridge MTLRenderPipelineReflection*)m_ptr fragmentArguments]};
}
...
Function RenderPipelineDescriptor::GetFragmentFunction() const {
  Validate();
  return ns::Handle{
      (__bridge void*)[(__bridge MTLRenderPipelineDescriptor*)m_ptr fragmentFunction]};
}

VertexDescriptor RenderPipelineDescriptor::GetVertexDescriptor() const {
  Validate();
  return ns::Handle{
      (__bridge void*)[(__bridge MTLRenderPipelineDescriptor*)m_ptr vertexDescriptor]};
}
...
ns::Array<RenderPipelineColorAttachmentDescriptor> RenderPipelineDescriptor::GetColorAttachments()
    const {
  Validate();
  return ns::Handle{
      (__bridge void*)[(__bridge MTLRenderPipelineDescriptor*)m_ptr colorAttachments]};
}
...
TessellationControlPointIndexType RenderPipelineDescriptor::GetTessellationControlPointIndexType()
    const {
  Validate();
#if MTLPP_IS_AVAILABLE(10_12, 10_0)
  return TessellationControlPointIndexType(
      [(__bridge MTLRenderPipelineDescriptor*)m_ptr tessellationControlPointIndexType]);
#else
...
TessellationFactorStepFunction RenderPipelineDescriptor::GetTessellationFactorStepFunction() const {
  ...
  return TessellationFactorStepFunction(
      [(__bridge MTLRenderPipelineDescriptor*)m_ptr tessellationFactorStepFunction]);
#else
...
void RenderPipelineDescriptor::SetVertexDescriptor(const VertexDescriptor& vertexDescriptor) {
  Validate();
  [(__bridge MTLRenderPipelineDescriptor*)m_ptr
      setVertexDescriptor:(__bridge MTLVertexDescriptor*)vertexDescriptor.GetPtr()];
}
...
void RenderPipelineDescriptor::SetStencilAttachmentPixelFormat(
  ...
  Validate();
  [(__bridge MTLRenderPipelineDescriptor*)m_ptr
      setStencilAttachmentPixelFormat:MTLPixelFormat(depthAttachmentPixelFormat)];
}
...
#if MTLPP_IS_AVAILABLE_MAC(10_11)
  [(__bridge MTLRenderPipelineDescriptor*)m_ptr
      setInputPrimitiveTopology:MTLPrimitiveTopologyClass(inputPrimitiveTopology)];
#endif
}
...
#if MTLPP_IS_AVAILABLE(10_12, 10_0)
  [(__bridge MTLRenderPipelineDescriptor*)m_ptr
      setTessellationPartitionMode:MTLTessellationPartitionMode(tessellationPartitionMode)];
#endif
}
...
#if MTLPP_IS_AVAILABLE(10_12, 10_0)
  [(__bridge MTLRenderPipelineDescriptor*)m_ptr
      setTessellationFactorFormat:MTLTessellationFactorFormat(tessellationFactorFormat)];
#endif
}
...
#if MTLPP_IS_AVAILABLE(10_12, 10_0)
  [(__bridge MTLRenderPipelineDescriptor*)m_ptr
      setTessellationOutputWindingOrder:MTLWinding(tessellationOutputWindingOrder)];
#endif
}

void RenderPipelineDescriptor::Reset() { [(__bridge MTLRenderPipelineDescriptor*)m_ptr reset]; }
...
PurgeableState Resource::SetPurgeableState(PurgeableState state) {
  ...
  return PurgeableState(
      [(__bridge id<MTLResource>)m_ptr setPurgeableState:MTLPurgeableState(state)]);
}
...
TextureDescriptor TextureDescriptor::Texture2DDescriptor(PixelFormat pixelFormat, uint32_t width,
...
TextureDescriptor TextureDescriptor::TextureCubeDescriptor(PixelFormat pixelFormat, uint32_t size,
                                                           bool mipmapped) {
  return ns::Handle{(__bridge void*)[MTLTextureDescriptor
...
void Texture::GetBytes(void* pixelBytes, uint32_t bytesPerRow, uint32_t bytesPerImage,
  ...
  [(__bridge id<MTLTexture>)m_ptr
      ...
      bytesPerImage:bytesPerImage
         fromRegion:MTLRegionMake3D(fromRegion.Origin.X, fromRegion.Origin.Y, fromRegion.Origin.Z,
                                    fromRegion.Size.Width, fromRegion.Size.Height,
                                    fromRegion.Size.Depth)
        mipmapLevel:mipmapLevel
              slice:slice];
}

void Texture::Replace(const Region& region, uint32_t mipmapLevel, uint32_t slice, void* pixelBytes,
                      uint32_t bytesPerRow, uint32_t bytesPerImage) {
  Validate();
  [(__bridge id<MTLTexture>)m_ptr
      replaceRegion:MTLRegionMake3D(region.Origin.X, region.Origin.Y, region.Origin.Z,
                                    region.Size.Width, region.Size.Height, region.Size.Depth)
        mipmapLevel:mipmapLevel
              slice:slice
...
void Texture::GetBytes(void* pixelBytes, uint32_t bytesPerRow, const Region& fromRegion,
...
void Texture::Replace(const Region& region, uint32_t mipmapLevel, void* pixelBytes,
                      uint32_t bytesPerRow) {
  Validate();
  [(__bridge id<MTLTexture>)m_ptr
      replaceRegion:MTLRegionMake3D(region.Origin.X, region.Origin.Y, region.Origin.Z,
...
Texture Texture::NewTextureView(PixelFormat pixelFormat, TextureType textureType,
                                const ns::Range& mipmapLevelRange, const ns::Range& sliceRange) {
  Validate();
  return ns::Handle{(__bridge void*)[(__bridge id<MTLTexture>)m_ptr
      newTextureViewWithPixelFormat:MTLPixelFormat(pixelFormat)
