...
class Device : public ns::Object {
 public:
  ...
  RenderPipelineState NewRenderPipelineState(
      const RenderPipelineDescriptor& descriptor, ns::Error* error);
  RenderPipelineState NewRenderPipelineState(
...
class ComputeCommandEncoder : public CommandEncoder {
 public:
  ...
  void DispatchThread(const Size& threadgroupsPerGrid,
                      const Size& threadsPerThreadgroup);
...
class RenderPipelineDescriptor : public ns::Object {
 public:
  ...
  ns::Array<RenderPipelineColorAttachmentDescriptor> GetColorAttachments()
      const;
